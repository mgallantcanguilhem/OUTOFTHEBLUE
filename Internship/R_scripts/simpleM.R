...
#============================================================================
# fix length, simpleM
fn_In <- "~/Documents/CollègeFr/Stage/Meff/genotype_matrix.txt"
mySNP_nonmissing <- read.table(fn_In, colClasses="integer")
#mySNP_nonmissing <- mySNP_nonmissing[-c(82540, 229186, 229187, 390213),]
...
cat("Bonferroni-corrected p-value threshold =", 0.05/sum(simpleMeff), "\n")
